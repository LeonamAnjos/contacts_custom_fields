...
ActiveRecord::Schema.define(version: 20160609185945) do
  ...
  add_index "contacts", ["custom_fields"], name: "index_contacts_on_custom_fields", using: :gist
  ...
  add_foreign_key "contact_custom_fields", "users"
